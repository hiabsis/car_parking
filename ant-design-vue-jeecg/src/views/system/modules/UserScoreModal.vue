<template>
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="用户账号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="username">
          <a-input placeholder="请输入用户账号" :disabled="true" v-model="model.username" :readOnly="!!model.id"/>
        </a-form-model-item>
        <a-form-model-item label="积分" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="score">
          <a-input placeholder="请输入积分" v-model="model.score" />
        </a-form-model-item>
    ...
    <div class="drawer-bootom-button" v-show="!disableSubmit">
      <a-popconfirm title="确定放弃充值？" @confirm="handleCancel" okText="确定" cancelText="取消">
...
<script>
  ...
  import { addUser,editUser,queryUserRole,queryall ,editUserScore} from '@/api/api'
    ...
    data () {
      return {
        ...
        validatorRules:{
          ...
          score: [{ required: false, message: '请输入积分' },],
        },
        departIdShow:false,
        title:"操作",
        visible: false,
