        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="用户名">
              <j-search-select-tag placeholder="请输入用户名" v-model="queryParam.userId" dict="sys_user,username,id,del_flag='0'"/>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="订单类型">
              <j-dict-select-tag type="list" v-model="queryParam.type" dictCode="order_type"  placeholder="请选择订单类型" />
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="订单编号">
              <j-search-select-tag placeholder="请输入订单编号" v-model="queryParam.orderNumner" dict="user_order,order_numner,order_numner"/>
...
<script>
  ...
  import UserOrderModal from './modules/UserOrderModal'
