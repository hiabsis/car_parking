  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="车主" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="userId">
          ...
          <a-col :span="24">
            <a-form-model-item label="车牌号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="number">
              <a-input v-model="model.number" placeholder="请输入车牌号"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
...
<!--          <a-col :span="24">-->
<!--            <a-form-model-item label="入库位置" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="parkingNumber">-->
<!--              <j-dict-select-tag type="list" v-model="model.parkingNumber" dictCode="car_type" placeholder="请选择车辆类型" />-->
<!--            </a-form-model-item>-->
<!--          </a-col>-->
          <a-col :span="24" v-if="titleForm === '详情'">
            <a-form-model-item label="状态" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="status">
              <j-dict-select-tag type="list" v-model="model.status" dictCode="car_status" placeholder="请选择状态" />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
