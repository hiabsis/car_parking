    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="车位号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="spaceId">
              <j-dict-select-tag type="list" v-model="model.spaceId" dictCode="space_manage,number,id" placeholder="请选择车位号" />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/car/carManagement/add",
          edit: "/car/carManagement/edit",
          queryById: "/car/carManagement/queryById"
        }
      }
    },
    computed: {
