        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="电话" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="phone">
              <a-input-number v-model="model.phone" placeholder="请输入电话" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/car/memberManagement/add",
          edit: "/car/memberManagement/edit",
          queryById: "/car/memberManagement/queryById"
        }
      }
    },
    computed: {
