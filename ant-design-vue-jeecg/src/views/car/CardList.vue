        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="用户">
              <j-search-select-tag placeholder="请选择用户" v-model="queryParam.userId" dict="sys_user,username,id,del_flag='0'"/>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--      <a-button type="primary" icon="download" @click="handleExportXls('会员卡')">导出</a-button>-->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'sel_search',value:'userId',text:'用户',dictTable:'sys_user', dictText:'username', dictCode:'id'})
        fieldList.push({type:'string',value:'number',text:'卡号',dictCode:''})
        fieldList.push({type:'string',value:'password',text:'支付密码',dictCode:''})
        fieldList.push({type:'sel_search',value:'carId',text:'绑定车辆',dictTable:'car', dictText:'number', dictCode:'id'})
