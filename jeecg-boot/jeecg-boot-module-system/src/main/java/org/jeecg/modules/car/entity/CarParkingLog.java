 ...
 */
@Data
@TableName("car_parking_log")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="car_parking_log对象", description="车辆入库记录")
public class CarParkingLog implements Serializable {
	...
	/**车位号*/
	@Excel(name = "车位号", width = 15, dictTable = "car_parking", dicText = "parking_number", dicCode = "id")
	@Dict(dictTable = "car_parking", dicText = "parking_number", dicCode = "id")
    @ApiModelProperty(value = "车位号")
    private java.lang.String parkingNumner;
	/**车牌号*/
	@Excel(name = "车牌号", width = 15, dictTable = "car", dicText = "number", dicCode = "id")
	@Dict(dictTable = "car", dicText = "number", dicCode = "id")
    @ApiModelProperty(value = "车牌号")
    private java.lang.String carNumner;
	/**入库时间*/
