<template>
  <a-card :bordered="false">
    ...
    <member-management-modal ref="modalForm" @ok="modalFormOk"></member-management-modal>
  </a-card>
</template>
...
<script>
  ...
  import MemberManagementModal from './modules/MemberManagementModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/manage/memberManagement/list",
          delete: "/manage/memberManagement/delete",
          deleteBatch: "/manage/memberManagement/deleteBatch",
          exportXlsUrl: "/manage/memberManagement/exportXls",
          importExcelUrl: "manage/memberManagement/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'int',value:'phone',text:'电话',dictCode:''})
